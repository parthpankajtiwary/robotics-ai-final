...
PLUGINLIB_EXPORT_CLASS(test_planner::GlobalPlannerPython, nav_core::BaseGlobalPlanner)
...
void GlobalPlannerPython::initialize(std::string name, costmap_2d::Costmap2DROS *costmap_ros) {
  ...
  if (!initialized_) {
    ...
    makeplan_service_ = private_nh.serviceClient<alice_msgs::MakePlan>("make_plan");
