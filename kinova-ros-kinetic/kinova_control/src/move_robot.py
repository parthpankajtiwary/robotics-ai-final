...
def argumentParser(argument):
  ...
  parser.add_argument('kinova_robotType', metavar='kinova_robotType', type=str, default='m1n6s200',
...
if __name__ == '__main__':
  try:    
    ...
    if (nbJoints==6):
      #home robots
      #moveJoint ([0.0,1.6,1.5, 1.2,1.4,0.0],prefix,nbJoints)
      moveJoint([-1.007420297507231, 2.878543293149818, 5.245727718308464, 0.3876156715228909, -0.8631810366765382, -2.4228588393413446], prefix, nbJoints)
    else:
